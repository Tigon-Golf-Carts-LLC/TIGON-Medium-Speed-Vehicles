...
export default function EvolutionD5Ranger22() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION D5 RANGER 2+2 Medium Speed Vehicle"
        description="Versatile Ranger with 2+2 seating configuration for flexible passenger arrangements. Premium build with Ranger performance. Call 1-844-844-6638."
        keywords="EVOLUTION D5 RANGER 2+2, versatile medium speed vehicle, 2+2 configuration, Ranger performance, flexible seating, EVOLUTION dealer nationwide"
        canonicalUrl="https://tigonmsv.com/vehicles/evolution-d5-ranger-2-2"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 text-white">
                ...
                <p className="text-xl drop-shadow-md mb-8 leading-relaxed">
                  Versatile Ranger with 2+2 seating configuration for flexible passenger arrangements. Premium build quality with legendary Ranger performance.
                </p>
                
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-orange">2+2 Configuration</div>
                    <div className="drop-shadow-lg">Ranger Performance</div>
                  </div>
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                  ...
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-orange">Flexible Seating</div>
                    <div className="drop-shadow-lg">Premium Build</div>
                  </div>
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a href="https://tigongolfcarts.com/evolution/d5-ranger/2-2/" target="_blank" rel="noopener noreferrer">
                    <Button size="lg" className="w-full sm:w-auto bg-theme-orange hover:bg-orange-600 text-white shadow-lg">
                      View More Details
                    </Button>
                  </a>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION D5 Ranger 2+2 Medium Speed Vehicle"
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">2+2 Configuration</h3>
                      <p className="text-gray-600">Versatile seating arrangement for flexible passenger and cargo options.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Shield className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Ranger Performance</h3>
                      <p className="text-gray-600">Legendary Ranger series performance with proven reliability and power.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Settings className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Flexible Seating</h3>
                      <p className="text-gray-600">Convertible rear area adapts to your passenger or cargo needs.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Award className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Premium Build</h3>
                      <p className="text-gray-600">High-quality construction with premium materials throughout.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Ranger Performance, Versatile Design
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Contact TIGON Medium Speed Vehicles today for your EVOLUTION D5 Ranger 2+2.
            </p>
