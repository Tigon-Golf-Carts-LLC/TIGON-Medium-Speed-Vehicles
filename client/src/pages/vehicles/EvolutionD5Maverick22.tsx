...
import vehicleImage from "@assets/EVOLUTIOND5MAVERICK2+2_1751893115780_1753135231312.jpg";

export default function EvolutionD5Maverick22() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION D5 MAVERICK 2+2 Medium Speed Vehicle"
        description="Versatile 2+2 configuration for flexible passenger and cargo arrangements. Compact design with reliable performance. Call 1-844-844-6638."
        keywords="EVOLUTION D5 MAVERICK 2+2, versatile medium speed vehicle, 2+2 configuration, flexible seating, cargo versatility, EVOLUTION dealer nationwide"
        canonicalUrl="https://tigonmsv.com/vehicles/evolution-d5-maverick-2-2"
        ...
        <nav className="py-4 px-4 bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <span>→</span>
              <span className="drop-shadow-lg">D5 Maverick 2+2</span>
            </div>
          </div>
        </nav>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 text-white">
                ...
                <p className="text-xl drop-shadow-md mb-8 leading-relaxed">
                  Versatile 2+2 configuration for flexible passenger and cargo arrangements. Compact design with reliable performance for everyday use.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  ...
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-orange">Cargo Versatility</div>
                    <div className="drop-shadow-lg">Compact Design</div>
                  </div>
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a href="https://tigongolfcarts.com/evolution/d5-maverick/2-2/" target="_blank" rel="noopener noreferrer">
                    <Button size="lg" className="w-full sm:w-auto bg-theme-orange hover:bg-orange-600 text-white shadow-lg">
                      View More Details
                    </Button>
                  </a>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION D5 Maverick 2+2 Medium Speed Vehicle"
        ...
        <section className="py-8 px-4 bg-green-50">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div>
                <div className="text-3xl font-bold text-theme-primary mb-2">$11,495</div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Versatile seating arrangement allows for flexible passenger and cargo combinations.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Convertible rear seating area adapts to your transportation needs.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Settings className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Cargo Versatility</h3>
                      <p className="text-gray-600">Enhanced cargo space when rear seats are folded for hauling equipment.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Maneuverable footprint perfect for tight spaces and narrow paths.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Contact TIGON Medium Speed Vehicles today for your EVOLUTION D5 Maverick 2+2.
            </p>
