...
import vehicleImage from "@assets/EVOLUTIOND5RANGER4+2PLUS(9)_1751893115782_1753135350622.jpg";

export default function EvolutionD5Ranger42Plus() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION D5 RANGER 4+2 PLUS Medium Speed Vehicle"
        description="Premium 4+2 Ranger configuration with 6-passenger capacity and advanced features. Extended range with superior performance. Call 1-844-844-6638."
        keywords="EVOLUTION D5 RANGER 4+2 PLUS, premium medium speed vehicle, 4+2 configuration, 6-passenger, extended range, EVOLUTION dealer nationwide"
        canonicalUrl="https://tigonmsv.com/vehicles/evolution-d5-ranger-4-2-plus"
        ...
        <nav className="py-4 px-4 bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <span>→</span>
              <span className="drop-shadow-lg">D5 Ranger 4+2 Plus</span>
            </div>
          </div>
        </nav>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 text-white">
                ...
                <p className="text-xl drop-shadow-md mb-8 leading-relaxed">
                  Premium 4+2 Ranger configuration with 6-passenger capacity and advanced features. Extended range capability with lithium power and premium amenities.
                </p>
                
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-orange">4+2 Configuration</div>
                  ...
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    ...
                    <div className="drop-shadow-lg">6-Passenger</div>
                  </div>
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a href="https://tigongolfcarts.com/evolution/d5-ranger/4-2-plus/" target="_blank" rel="noopener noreferrer">
                    <Button size="lg" className="w-full sm:w-auto bg-theme-orange hover:bg-orange-600 text-white shadow-lg">
                      View More Details
                    </Button>
                  </a>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION D5 Ranger 4+2 Plus Premium Medium Speed Vehicle"
        ...
        <section className="py-8 px-4 bg-green-50">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div>
                <div className="text-3xl font-bold text-theme-primary mb-2">$15,495</div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">4+2 Configuration</h3>
                      <p className="text-gray-600">Innovative seating arrangement provides 6 passenger capacity with flexible rear options.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Comprehensive premium feature set with upgraded materials and components.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Advanced lithium battery technology provides extended driving range.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Comfortable seating for six adults, perfect for family and group outings.</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between py-3">
                        ...
                        <span className="drop-shadow-lg">1100 lbs</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
        ...
        <section className="py-16 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Maximum Capacity, Premium Performance
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Contact TIGON Medium Speed Vehicles today for your EVOLUTION D5 Ranger 4+2 Plus.
            </p>
