...
export default function EvolutionForester6Plus() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION FORESTER 6 PLUS Medium Speed Vehicle"
        description="Premium 6-passenger utility vehicle with heavy-duty features for work and recreation. Built for demanding applications. Call 1-844-844-6638."
        keywords="EVOLUTION FORESTER 6 PLUS, 6-passenger utility vehicle, heavy duty, work ready, utility features, EVOLUTION dealer nationwide"
        canonicalUrl="https://tigonmsv.com/vehicles/evolution-forester-6-plus"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 text-white">
                ...
                <p className="text-xl drop-shadow-md mb-8 leading-relaxed">
                  Premium 6-passenger utility vehicle with heavy-duty features for work and recreation. Built for demanding applications with rugged construction.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  ...
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-orange">Utility Features</div>
                    <div className="drop-shadow-lg">Work Ready</div>
                  </div>
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-orange">Payload</div>
                    <div className="drop-shadow-lg">1400 lbs</div>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a href="https://tigongolfcarts.com/evolution/forester/6-plus/" target="_blank" rel="noopener noreferrer">
                    <Button size="lg" className="w-full sm:w-auto bg-theme-orange hover:bg-orange-600 text-white shadow-lg">
                      View More Details
                    </Button>
                  </a>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION Forester 6 Plus Premium Utility Medium Speed Vehicle"
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Spacious seating for six adults with comfortable arrangements for work crews or families.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Shield className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Heavy Duty</h3>
                      <p className="text-gray-600">Rugged construction with reinforced frame and components for demanding applications.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Designed with utility in mind, featuring practical options for work applications.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Built for professional use with enhanced durability and practical features.</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between py-3">
                        ...
                        <span className="drop-shadow-lg">1400 lbs</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
        ...
        <section className="py-16 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Contact TIGON Medium Speed Vehicles today for your EVOLUTION Forester 6 Plus.
            </p>
