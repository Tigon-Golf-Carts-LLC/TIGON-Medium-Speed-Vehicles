...
import vehicleImage from "@assets/EVOLUTIONCLASSIC4PRO_1751893115780_1753135231314.jpg";

export default function EvolutionClassic4Pro() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION CLASSIC 4 PRO Medium Speed Vehicle"
        description="Professional grade 4-passenger classic with enhanced performance features and premium appointments. Classic styling meets modern technology. Call 1-844-844-6638."
        keywords="EVOLUTION CLASSIC 4 PRO, professional grade medium speed vehicle, 4-passenger, enhanced performance, premium features, EVOLUTION dealer nationwide"
        canonicalUrl="https://tigonmsv.com/vehicles/evolution-classic-4-pro"
        image="/attached_assets/EVOLUTIONCLASSIC4PRO_1751893115780_1753135231314.jpg"
      />
        ...
        <nav className="py-4 px-4 bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <span>→</span>
              <span className="drop-shadow-lg">Classic 4 Pro</span>
            </div>
          </div>
        </nav>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 text-white">
                ...
                <p className="text-xl drop-shadow-md mb-8 leading-relaxed">
                  Professional grade 4-passenger classic with enhanced performance features and premium appointments. Experience classic styling with modern technology and reliability.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    ...
                    <div className="drop-shadow-lg">Enhanced Performance</div>
                  </div>
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-orange">Range</div>
                    <div className="drop-shadow-lg">40-50 miles</div>
                  </div>
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-orange">Premium Features</div>
                    <div className="drop-shadow-lg">Classic Styling</div>
                  </div>
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a href="https://tigongolfcarts.com/evolution/classic/4-pro/" target="_blank" rel="noopener noreferrer">
                    <Button size="lg" className="w-full sm:w-auto bg-theme-orange hover:bg-orange-600 text-white shadow-lg">
                      View More Details
                    </Button>
                  </a>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION Classic 4 Pro Premium Medium Speed Vehicle"
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Built to professional standards with enhanced durability and performance for demanding applications.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Superior motor and drivetrain components deliver reliable power and consistent performance.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Comprehensive feature set including comfort enhancements and convenience options.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Award className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Classic Styling</h3>
                      <p className="text-gray-600">Timeless design elements combined with modern aesthetics for an elegant appearance.</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between py-3 border-b border-gray-200">
                        ...
                        <span className="drop-shadow-lg">40-50 miles</span>
                      </div>
                      <div className="flex items-center justify-between py-3 border-b border-gray-200">
                        <div className="flex items-center gap-3">
        ...
        <section className="py-16 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Classic Styling, Professional Performance
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Contact TIGON Medium Speed Vehicles today for your EVOLUTION Classic 4 Pro.
            </p>
