...
import vehicleImage from "@assets/EVOLUTIONTURFMAN800_1751893159006_1753135437836.jpg";

export default function EvolutionTurman800Plus() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION TURMAN 800 PLUS Medium Speed Vehicle"
        description="Mid-range commercial utility vehicle with 800 lbs payload capacity for versatile landscaping and maintenance operations. Call 1-844-844-6638."
        keywords="EVOLUTION TURMAN 800 PLUS, commercial utility vehicle, landscaping cart, maintenance vehicle, mid-range commercial, EVOLUTION dealer nationwide"
        canonicalUrl="https://tigonmsv.com/vehicles/evolution-turman-800-plus"
        ...
        <nav className="py-4 px-4 bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <span>→</span>
              <span className="drop-shadow-lg">TURMAN 800 PLUS</span>
            </div>
          </div>
        </nav>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 text-white">
                ...
                <p className="text-xl drop-shadow-md mb-8 leading-relaxed">
                  Mid-range commercial utility vehicle with 800 lbs payload capacity. Versatile solution for landscaping and maintenance operations.
                </p>
                
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-orange">Commercial Mid-Range</div>
                    <div className="drop-shadow-lg">Versatile</div>
                  </div>
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                  ...
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    ...
                    <div className="drop-shadow-lg">Commercial Use</div>
                  </div>
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-orange">Payload</div>
                    <div className="drop-shadow-lg">800 lbs</div>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a href="https://tigongolfcarts.com/evolution/turfman/800/" target="_blank" rel="noopener noreferrer">
                    <Button size="lg" className="w-full sm:w-auto bg-theme-orange hover:bg-orange-600 text-white shadow-lg">
                      View More Details
                    </Button>
                  </a>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION TURMAN 800 PLUS Commercial Utility Medium Speed Vehicle"
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Mid-Range Capacity</h3>
                      <p className="text-gray-600">800 lbs payload capacity for versatile commercial operations.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Shield className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Versatile Payload</h3>
                      <p className="text-gray-600">Adaptable cargo capacity for various landscaping and maintenance tasks.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Settings className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Commercial Grade</h3>
                      <p className="text-gray-600">Built with commercial-grade components for demanding operations.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Designed for professional landscaping and turf maintenance.</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between py-3 border-b border-gray-200">
                        ...
                        <span className="drop-shadow-lg">Commercial Grade</span>
                      </div>
                      <div className="flex items-center justify-between py-3 border-b border-gray-200">
                        <div className="flex items-center gap-3">
        ...
        <section className="py-16 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Mid-Range Commercial, Professional Performance
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Contact TIGON Medium Speed Vehicles today for your EVOLUTION TURMAN 800 PLUS.
            </p>
