...
export default function EvolutionD5Maverick22Plus() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION D5 MAVERICK 2+2 PLUS Medium Speed Vehicle"
        description="Premium 2+2 configuration with enhanced features and extended range capability. Lithium powered for superior performance. Call 1-844-844-6638."
        keywords="EVOLUTION D5 MAVERICK 2+2 PLUS, premium medium speed vehicle, 2+2 configuration, extended range, lithium power, EVOLUTION dealer nationwide"
        canonicalUrl="https://tigonmsv.com/vehicles/evolution-d5-maverick-2-2-plus"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 text-white">
                ...
                <p className="text-xl drop-shadow-md mb-8 leading-relaxed">
                  Premium 2+2 configuration with enhanced features and extended range capability. Powered by advanced lithium technology for superior performance.
                </p>
                
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-orange">Premium 2+2</div>
                    <div className="drop-shadow-lg">Extended Range</div>
                  </div>
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                  ...
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-orange">Enhanced Features</div>
                    <div className="drop-shadow-lg">Lithium Power</div>
                  </div>
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a href="https://tigongolfcarts.com/evolution/d5-maverick/2-2-plus/" target="_blank" rel="noopener noreferrer">
                    <Button size="lg" className="w-full sm:w-auto bg-theme-orange hover:bg-orange-600 text-white shadow-lg">
                      View More Details
                    </Button>
                  </a>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION D5 Maverick 2+2 Plus Premium Medium Speed Vehicle"
        ...
        <section className="py-8 px-4 bg-green-50">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div>
                <div className="text-3xl font-bold text-theme-primary mb-2">$12,495</div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Premium 2+2</h3>
                      <p className="text-gray-600">Enhanced 2+2 configuration with premium materials and upgraded components.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Advanced battery technology provides extended driving range for longer adventures.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Premium feature set including upgraded comfort and convenience options.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Award className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Lithium Power</h3>
                      <p className="text-gray-600">Modern lithium ion battery system for reliable, efficient power delivery.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Premium Features, Extended Range
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Contact TIGON Medium Speed Vehicles today for your EVOLUTION D5 Maverick 2+2 Plus.
            </p>
