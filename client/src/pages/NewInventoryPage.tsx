  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-blue-600 to-green-600 text-white py-16 bg-cover bg-center bg-no-repeat" style={{backgroundImage: "linear-gradient(rgba(37, 99, 235, 0.8), rgba(22, 163, 74, 0.8)), url('https://tigonmsv.com/attached_assets/TIGON%20-%20Medium%20Speed%20Vehicles%203_1763146957907.jpeg')"}}>
