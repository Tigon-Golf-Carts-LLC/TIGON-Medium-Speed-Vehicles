...
export default function ShowroomPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 bg-gradient-to-r from-theme-primary to-blue-700 text-white bg-cover bg-center bg-no-repeat" style={{backgroundImage: "linear-gradient(rgba(14, 46, 85, 0.8), rgba(29, 78, 216, 0.8)), url('https://tigonmsv.com/attached_assets/TIGON - Medium Speed Vehicles 4_1763146957907.jpeg')"}}>
